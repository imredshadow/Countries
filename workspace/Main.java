...
public class Main 
{
  ...
  public void loadCountries() 
  {
    ...
    // Optional: skip header line if your CSV has one
    if (scan.hasNextLine()) {
      scan.nextLine();
    }
    ...
    while (scan.hasNextLine() && i < countryArray.length) {
      ...
      // Create Country object using 4 arguments
  ...
  */
  public void showCountry() {
    ...
    outputLabel.setText("What country is shown on the map?");
  }
  ...
  */
  public void quizButtonClick()
  {
    ...
    if (userAnswer.equals(correctAnswer)) {
      ...
      outputLabel.setText("Incorrect, the answer is " + correctAnswer);
    }
